...
public interface IBusinessCircle {
     ...
     * @return 返回结果集
     */
    public List<CommonFriendNum> searchCommonFriendNum(String loginAccount,List<String> userNames);
    @Deprecated
     ...
     * @return
     */
    public List<PersonRelation> searchPersonRelation(String loginAccount,List<String> userIds);
    @Deprecated
